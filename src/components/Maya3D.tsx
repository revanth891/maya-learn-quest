...
const MayaSphere: React.FC<MayaProps> = ({ message, showMessage = false, scale = 1 }) => {
    ...
    <group>
      ...
      {showMessage && (
        <Html position={[0, 2, 0]} center>
          <div className="bg-glass/80 backdrop-blur-sm border border-glass-border rounded-lg p-3 max-w-48 text-center shadow-glass">
            <p className="text-glass-foreground text-sm font-medium">
  ...
  return (
    <div className={`${className}`} style={{ height }}>
      ...
      >
        ...
        <MayaSphere message={message} showMessage={showMessage} scale={scale} />
      </Canvas>
    </div>
  );
};
