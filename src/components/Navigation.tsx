  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/20 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* UK dropdown + stats (desktop only) */}
            <div className="hidden md:flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2 glass backdrop-blur-xl rounded-lg px-3 py-1 border border-white/20 hover:scale-105 transition-transform">
                  <Zap className="w-4 h-4 text-warning" />
                  <span className="text-sm font-medium text-foreground">{points} IP</span>
                </div>
                <div className="flex items-center space-x-2 glass backdrop-blur-xl rounded-lg px-3 py-1 border border-white/20 hover:scale-105 transition-transform">
                  <Trophy className="w-4 h-4 text-success" />
                  <span className="text-sm font-medium text-foreground">
      ...
      >
            ...
            {navItems.map((item) => {
              ...
              return (
                <Button
                  ...
                  size="sm"
                  asChild
                  className={`flex-col h-12 px-3 rounded-2xl transition-all duration-300 ${
        ...
        {/* Optional subtle home indicator */}
        <div className="mx-auto mt-2 h-1.5 w-24 rounded-full bg-white/20"></div>
      </div>
    </>
  );
};
